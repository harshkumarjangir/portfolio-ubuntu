    ...
    const projects = [
        {
            ...
            description: 'Intelligent news platform using Gemini AI for content curation and analysis',
            detailedDescription: 'A comprehensive news aggregation platform that leverages Google\'s Gemini AI to intelligently curate, categorize, and analyze news content from multiple sources. Features include real-time sentiment analysis, automatic categorization, personalized recommendations, and trend detection.',
            tech: ['React', 'Node.js', 'MongoDB', 'Gemini AI'],
            features: [
                'AI-powered content curation using Gemini API',
            ...
            challenges: 'Implementing efficient data processing for large volumes of news articles while maintaining real-time performance and ensuring accurate AI-driven content analysis.',
        ...
        },
        {
            ...
            detailedDescription: 'A complete food delivery platform built with modern web technologies. Features include restaurant management, real-time order tracking, payment integration, user authentication, and an admin dashboard for comprehensive business management.',
        ...
        },
        {
            ...
            detailedDescription: 'A sophisticated e-commerce platform showcasing advanced Redux state management patterns. Built with modern React practices, featuring complex state interactions, optimistic updates, and seamless user experience with Bootstrap UI components.',
        ...
        },
        {
            ...
            detailedDescription: 'A powerful document conversion tool that transforms DOCX files to PDF format with high fidelity. Features include batch processing, drag-and-drop interface, format preservation, and download management with progress tracking.',
            tech: ['React', 'Tailwind', 'Express', 'Docx-pdf'],
            features: [
                'Drag-and-drop file upload interface',
                'Batch processing for multiple documents',
                'Format and styling preservation',
        ...
        <div className={`min-h-screen transition-all duration-500 ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
            ...
            <AnimatePresence>
                {selectedProject && (
                    ...
                    >
                        <motion.div
                            className={`relative max-w-4xl w-full max-h-[90vh] overflow-y-auto rounded-3xl ${isDark ? 'bg-gray-900' : 'bg-white'} border ${isDark ? 'border-gray-700' : 'border-gray-200'} shadow-2xl`}
